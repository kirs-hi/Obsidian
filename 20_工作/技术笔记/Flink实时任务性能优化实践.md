...
Fetching document 1385153066......
数据是新时代的石油，数据是企业的核心资产，大数据的价值向来不乏溢美之词，但价值的发掘需要建立在「能用」和「善用」的数据技术基础之上。因此数据开发通道发起并创办了《数据技术》期刊，希望本着启智研学、学以致用的精神，以传数据道、育数据人为目的，为数据开发同学提供一个学习渠道和交流平台。

**|**
内部技术博客的优秀文章将会被推荐到「技术头条」（内部IM推送全体技术同学、总TC成员）和「某互联网公司技术团队」社群平台公众号（目前超过35万关注者），欢迎大家积极踊跃地投稿。投稿请联系
。

**|** 如果你对本文中的内容有疑惑、想交流，或者发现文章内容有错误之处，请联系本文作者。想给《数据技术》期刊投稿，请联系。
...
某互联网公司配送作为某互联网公司万物到家的基础，拥有海量的数据和丰富的实时业务场景，致力于应用业界先进的数据计算技术架构，保障业务数据的时效性、一致性、准确性、完整性，为业务的运营管理、策略决策和算法策略提供完善的数据体系和基于数据科学的决策能力。数据团队的团队定位是即时配送业务数据体系和数据产品的建设者，通过技术应用和创新助力业务打造数字化与智能化的即时配送平台。在即时配送业务规模不断扩大的同时数据链路复杂度、任务数量也在增加，对实时任务的性能要求也越来越高；现阶段实时任务存在以下两个问题：
...
# 七、作者介绍
 ...
 ，数据研发工程师，2021年加入某互联网公司点评，主要负责某互联网公司配送实时数据开发工作

 ，数据研发工程师，2021年加入某互联网公司点评，主要负责某互联网公司配送实时特征开发工作

 ，数据研发工程师，2020年加入某互联网公司点评，主要负责某互联网公司配送实时数据开发工作
