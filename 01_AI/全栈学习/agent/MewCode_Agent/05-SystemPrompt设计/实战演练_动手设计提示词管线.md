...
![](assets/实战演练_动手设计提示词管线-1.jpeg)

经过一段时间后，开发完成。

![](assets/实战演练_动手设计提示词管线-2.jpeg)
...
![](assets/实战演练_动手设计提示词管线-3.jpeg)

可以看到，这里会告诉LLM他是谁，那么我们启动MewCode，在没有任何我们去提示上下文的情况下，输入

你是谁，什么名字

![](assets/实战演练_动手设计提示词管线-4.jpeg)

可以看到我们的身份是注入成功的，LLM已经知道自己是谁

「环境」层信息注入

![](assets/实战演练_动手设计提示词管线-5.jpeg)

这个其实我们上面那张图也展示出来了

![](assets/实战演练_动手设计提示词管线-6.jpeg)

「system」层这里，我们能看到是这样的信息

![](assets/实战演练_动手设计提示词管线-7.jpeg)

在MewCode输入

工具结果可能包含什么

![](assets/实战演练_动手设计提示词管线-8.jpeg)

我们可以看到，它已经能根据system提示词的指引去回答问题了

「DoingTasks」层，提示词这样

![](assets/实战演练_动手设计提示词管线-9.jpeg)

我们打开MewCode，输入

你对于代码的抽象会怎么做

![](assets/实战演练_动手设计提示词管线-10.jpeg)

我们能看到这里是能对应上的，这层没问题

「ExecutingActions」层，提示词如下

![](assets/实战演练_动手设计提示词管线-11.jpeg)

打开MewCode，输入

你觉得哪些执行操作，需要谨慎

![](assets/实战演练_动手设计提示词管线-12.jpeg)

也是对照着我们的提示词的，这块没问题

「UsingTools」层，提示词是这样的

![](assets/实战演练_动手设计提示词管线-13.jpeg)

我们输入

你使用工具时，需要注意什么

![](assets/实战演练_动手设计提示词管线-14.jpeg)

跟提示词对得上，这块没问题

「ToneStyle」层，提示词如下

![](assets/实战演练_动手设计提示词管线-15.jpeg)

我们在MewCode，输入

你什么情况才能回复emoji

![](assets/实战演练_动手设计提示词管线-16.jpeg)

可以看到，这层也遵守了，没问题

「TextOutput」层，提示词如下

![](assets/实战演练_动手设计提示词管线-17.jpeg)

我们打开MewCode，输入

你的文本输出有什么限制

![](assets/实战演练_动手设计提示词管线-18.jpeg)
