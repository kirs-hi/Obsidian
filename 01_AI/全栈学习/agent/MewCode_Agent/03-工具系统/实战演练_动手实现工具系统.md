...
![](assets/实战演练_动手实现工具系统-2.jpeg)

经过一段时间后，开发完成。

![](assets/实战演练_动手实现工具系统-3.jpeg)
...
![](assets/实战演练_动手实现工具系统-4.jpeg)

可以看到模型已经知道我们注册的六大工具和延后加载工具了，接着我们输入「帮我看看项目入口文件有什么」。

![](assets/实战演练_动手实现工具系统-5.jpeg)
...
![](assets/实战演练_动手实现工具系统-6.jpeg)

写入文件，会调用WriteFile

写入一个文件note.txt，内容是：这是测试文件

![](assets/实战演练_动手实现工具系统-7.jpeg)

文件内容也是成功写入了

![](assets/实战演练_动手实现工具系统-8.jpeg)

要编辑文件，会调用EditFIle

用editfile把note的内容改成编辑两个字

![](assets/实战演练_动手实现工具系统-9.jpeg)

我们可以看到文件内容变成了编辑了

![](assets/实战演练_动手实现工具系统-10.jpeg)

要搜索文件，会用Grep、Bash、Read

搜索编辑这两个字在哪里

![](assets/实战演练_动手实现工具系统-11.jpeg)
