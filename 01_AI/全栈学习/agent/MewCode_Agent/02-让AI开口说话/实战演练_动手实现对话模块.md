...
![](assets/实战演练_动手实现对话模块-3.jpeg)

经过一段时间后，就会开发完成，对应的总结也会告诉我们，让我们了解情况

![](assets/实战演练_动手实现对话模块-4.jpeg)
