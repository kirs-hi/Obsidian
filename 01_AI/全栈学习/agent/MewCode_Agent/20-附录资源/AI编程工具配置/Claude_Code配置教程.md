...
![](assets/Claude_Code配置教程-2.jpeg)

如果订阅了Claude，只需要在本地终端输入Claude，然后用下面截图第一种方式，网页授权登录即可使用

![](assets/Claude_Code配置教程-3.jpeg)
...
![](assets/Claude_Code配置教程-9.jpeg)

我们可以输入一句你好试试

![](assets/Claude_Code配置教程-10.jpeg)
