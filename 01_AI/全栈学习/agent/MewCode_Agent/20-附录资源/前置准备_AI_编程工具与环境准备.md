...
![](assets/前置准备_AI_编程工具与环境准备-1.jpeg)
...
![](assets/前置准备_AI_编程工具与环境准备-2.jpeg)
...
![](assets/前置准备_AI_编程工具与环境准备-3.jpeg)
...
![](assets/前置准备_AI_编程工具与环境准备-4.jpeg)

然后我们让Claude Code 用这个MCP去搜索有没有好的cli交互框架，然后它就会调用context7MCP，去搜索了

![](assets/前置准备_AI_编程工具与环境准备-5.jpeg)
