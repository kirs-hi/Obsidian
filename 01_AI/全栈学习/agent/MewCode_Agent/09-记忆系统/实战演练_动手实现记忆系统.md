...
![](assets/实战演练_动手实现记忆系统-2.jpeg)

然后启动MewCode，先来验证下项目指令加载，进入后问 Agent：

**这个项目用的什么技术栈**

![](assets/实战演练_动手实现记忆系统-3.jpeg)
