...
![](assets/实战演练_动手实现上下文管理-1.jpeg)

经过一段时间后，开发完成。

![](assets/实战演练_动手实现上下文管理-2.jpeg)
